...
interface EvermarkRecord {
  ...
  // ArDrive storage fields
  ardrive_image_tx?: string;
  ardrive_metadata_tx?: string;
    ...
    switch (httpMethod) {
      ...
      case 'POST':
        ...
        const newEvermark: Partial<EvermarkRecord> = {
          ...
          metadata_json: evermarkData.metadata_json || evermarkData.metadata || undefined,
          ipfs_image_hash: evermarkData.ipfs_image_hash || undefined,
          // ipfs_metadata_hash: evermarkData.ipfs_metadata_hash || undefined, // Check if this column exists
          supabase_image_url: evermarkData.supabase_image_url || undefined,
          // ArDrive storage fields
          ardrive_image_tx: evermarkData.ardrive_image_tx || undefined,
          ardrive_metadata_tx: evermarkData.ardrive_metadata_tx || undefined,
